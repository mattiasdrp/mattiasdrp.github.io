...
var $author$project$Main$init_array = function (size) {
	return A3(
		$elm$core$Array$set,
		(size / 2) | 0,
		1,
...
var $author$project$Main$temp_rule_to_model = function (model) {
	var rule = $elm$core$Array$fromList(
		A2(
			$elm$core$List$map,
			function (c) {
				return _Utils_eq(
...
var $author$project$Main$aget = F3(
	function (index, array, size) {
		return A2(
			$elm$core$Maybe$withDefault,
			-1,
			A2(
...
var $author$project$Main$update_array = function (model) {
	var array = A2(
		$elm$core$Array$indexedMap,
		F2(
			function (index, c) {
				var lookat = 7 - $icidasset$elm_binary$Binary$toDecimal(
					$icidasset$elm_binary$Binary$fromIntegers(
						_List_fromArray(
							[
								A3($author$project$Main$aget, index - 1, model.array, model.size),
								c,
								A3($author$project$Main$aget, index + 1, model.array, model.size)
							])));
				return A2(
					$elm$core$Maybe$withDefault,
					-1,
					A2($elm$core$Array$get, lookat, model.rule));
			}),
		model.array);
	return array;
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$ChangedRule)
					]),
				_List_fromArray(
					[
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$int)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"ChangedRule":[],"RuleInputChanged":["String.String"],"Tick":[],"Toggle":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));