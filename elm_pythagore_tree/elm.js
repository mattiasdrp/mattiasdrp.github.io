...
var $author$project$Main$AlphaChange = function (a) {
	return {$: 'AlphaChange', a: a};
};
var $author$project$Main$GammaChange = function (a) {
	return {$: 'GammaChange', a: a};
};
...
var $author$project$Main$init = {
	alpha: $carwow$elm_slider$SingleSlider$init(
		{max: 360, min: 0, onChange: $author$project$Main$AlphaChange, step: 1, value: 60}),
	depth: 2,
	gamma: $carwow$elm_slider$SingleSlider$init(
		{max: 360, min: 0, onChange: $author$project$Main$GammaChange, step: 1, value: 60})
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'IncrementDepth':
				return (model.depth === 12) ? model : _Utils_update(
					model,
					{depth: model.depth + 1});
			case 'DecrementDepth':
				return (model.depth === 1) ? model : _Utils_update(
					model,
					{depth: model.depth - 1});
			case 'AlphaChange':
				var angle = msg.a;
				return _Utils_update(
					model,
					{
						alpha: A2($carwow$elm_slider$SingleSlider$update, angle, model.alpha)
					});
			default:
				var angle = msg.a;
				return _Utils_update(
					model,
					{
						gamma: A2($carwow$elm_slider$SingleSlider$update, angle, model.gamma)
					});
		}
	});
var $author$project$Main$DecrementDepth = {$: 'DecrementDepth'};
var $author$project$Main$IncrementDepth = {$: 'IncrementDepth'};
...
var $author$project$Pythagoras_tree$box_size = 1000;
var $author$project$Pythagoras_tree$edge = 100;
var $elm$core$Basics$atan2 = _Basics_atan2;
var $author$project$Pythagoras_tree$arg = F2(
	function (c1, c2) {
		return (_Utils_eq(c2.x, c1.x) && _Utils_eq(c2.y, c1.y)) ? 0 : A2($elm$core$Basics$atan2, c1.y - c2.y, c2.x - c1.x);
	});
...
var $author$project$Pythagoras_tree$distance = F2(
	function (c1, c2) {
		return $elm$core$Basics$sqrt(
			A2($elm$core$Basics$pow, c1.y - c2.y, 2) + A2($elm$core$Basics$pow, c1.x - c2.x, 2));
	});
var $elm$core$Basics$sin = _Basics_sin;
var $author$project$Pythagoras_tree$next_2_squares = F4(
	function (angle1, angle2, a, b) {
		var delta = $elm$core$Basics$degrees((180 - angle1) - angle2);
		var beta = A2($author$project$Pythagoras_tree$arg, a, b);
		var alpha = $elm$core$Basics$degrees(angle1);
		var ab = A2($author$project$Pythagoras_tree$distance, a, b);
		var ac = (ab * $elm$core$Basics$sin(delta)) / $elm$core$Basics$sin(alpha + delta);
		var dx1 = ac * $elm$core$Basics$cos(alpha + beta);
		var xc = a.x + dx1;
		var dx2 = b.x - xc;
		var yg = b.y - dx2;
		var yd = a.y - dx1;
		var dy1 = ac * $elm$core$Basics$sin(alpha + beta);
		var xd = a.x - dy1;
		var xe = xc - dy1;
		var yc = a.y - dy1;
		var dy2 = b.y - yc;
		...
		return _Utils_Tuple2(square1, square2);
	});
var $author$project$Pythagoras_tree$aux_generate_squares = F5(
	function (angle1, angle2, depth, squares, acc) {
		aux_generate_squares:
		while (true) {
			if (depth === 1) {
				return acc;
			} else {
				var _v0 = A3(
					...
					F2(
						function (square, _v1) {
							var ttacc = _v1.a;
							var nnacc = _v1.b;
							var _v2 = A4($author$project$Pythagoras_tree$next_2_squares, angle1, angle2, square.c1, square.c2);
							var s1 = _v2.a;
							var s2 = _v2.b;
							return _Utils_Tuple2(
								A2(
									$elm$core$List$cons,
									s1,
									A2($elm$core$List$cons, s2, ttacc)),
								A2(
									$elm$core$List$cons,
									s1,
									A2($elm$core$List$cons, s2, nnacc)));
						}),
					_Utils_Tuple2(_List_Nil, acc),
					squares);
				var tacc = _v0.a;
				var nacc = _v0.b;
				var $temp$angle1 = angle1,
					$temp$angle2 = angle2,
					$temp$depth = depth - 1,
					$temp$squares = tacc,
					$temp$acc = nacc;
				...
				acc = $temp$acc;
				continue aux_generate_squares;
			}
		}
	});
var $author$project$Pythagoras_tree$generate_squares = F4(
	function (angle1, angle2, depth, squares) {
		return A5($author$project$Pythagoras_tree$aux_generate_squares, angle1, angle2, depth, squares, squares);
	});
...
var $author$project$Pythagoras_tree$pair_coord = function (_v0) {
	var x = _v0.x;
	var y = _v0.y;
...
var $elm_community$typed_svg$TypedSvg$Attributes$stroke = A2(
	...
	$elm_community$typed_svg$TypedSvg$TypesToStrings$paintToString);
var $author$project$Pythagoras_tree$square_to_svg = function (_v0) {
	var c1 = _v0.c1;
	var c2 = _v0.c2;
	var c3 = _v0.c3;
	var c4 = _v0.c4;
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Pythagoras_tree$pair_coord(c1),
						$author$project$Pythagoras_tree$pair_coord(c2),
						$author$project$Pythagoras_tree$pair_coord(c3),
						$author$project$Pythagoras_tree$pair_coord(c4)
					])),
...
var $author$project$Pythagoras_tree$view_pythagoras_tree = F3(
	function (angle1, angle2, depth) {
		var square = {
			c1: {x: ($author$project$Pythagoras_tree$box_size / 2) - ($author$project$Pythagoras_tree$edge / 2), y: $author$project$Pythagoras_tree$box_size - (3 * $author$project$Pythagoras_tree$edge)},
			c2: {x: ($author$project$Pythagoras_tree$box_size / 2) + ($author$project$Pythagoras_tree$edge / 2), y: $author$project$Pythagoras_tree$box_size - (3 * $author$project$Pythagoras_tree$edge)},
			c3: {x: ($author$project$Pythagoras_tree$box_size / 2) + ($author$project$Pythagoras_tree$edge / 2), y: $author$project$Pythagoras_tree$box_size - (2 * $author$project$Pythagoras_tree$edge)},
			c4: {x: ($author$project$Pythagoras_tree$box_size / 2) - ($author$project$Pythagoras_tree$edge / 2), y: $author$project$Pythagoras_tree$box_size - (2 * $author$project$Pythagoras_tree$edge)}
		};
		var squares = A4(
			$author$project$Pythagoras_tree$generate_squares,
			angle1,
			angle2,
			depth,
			_List_fromArray(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm_community$typed_svg$TypedSvg$Types$px($author$project$Pythagoras_tree$box_size)),
					$elm_community$typed_svg$TypedSvg$Attributes$height(
					$elm_community$typed_svg$TypedSvg$Types$px($author$project$Pythagoras_tree$box_size))
				]),
			A2($elm$core$List$map, $author$project$Pythagoras_tree$square_to_svg, squares));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$DecrementDepth)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('-')
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromFloat(model.depth))
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$IncrementDepth)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('+')
				...
				_List_fromArray(
					[
						$carwow$elm_slider$SingleSlider$view(model.alpha),
						$carwow$elm_slider$SingleSlider$view(model.gamma)
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						A3(
						$author$project$Pythagoras_tree$view_pythagoras_tree,
						$carwow$elm_slider$SingleSlider$fetchValue(model.alpha),
						$carwow$elm_slider$SingleSlider$fetchValue(model.gamma),
						model.depth)
					]))
			]));
};
